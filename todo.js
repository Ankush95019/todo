...
add.addEventListener('click', ()=>{
  ...
  if(window.innerWidth > 600) titleTag.focus();
});
...
function updatNote(noteID, title, filterDesc) {
...
/* this is for NAVBAR hireme */
let hireme = document.getElementById("hireme");
hireme.addEventListener("click",()=>{
  window.open('mailto:ankush4031@gmail.com','_blank');
